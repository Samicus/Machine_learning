...
class TGameBoard:
    ...
    def __init__(self,N_row,N_col,tile_size,max_tile_count,agent,stochastic_prob):
        ...
        if self.tile_size==2:
            ...
            # The second dimension consist of pairs giving the y range: first element 
            # in the pair is the first row of the tile and the second element second is the 
            # last row plus 1 of the tile for the current column
            self.tiles = [
                [[[0,2]], [[0,1],[0,1]]],
                [[[0,1],[1,2]], [[1,2],[0,1]]],
